...
stateId INT NOT NULL,
PRIMARY KEY (cityId),
CONSTRAINT city_relates_to_state FOREIGN KEY (stateId) REFERENCES state (stateId) ON DELETE CASCADE ON UPDATE CASCADE
)
ALTER TABLE [dbo].[city] ADD CONSTRAINT UnionTerritory DEFAULT NULL FOR stateId;

INSERT INTO [dbo].[state] VALUES
...
cityId INT NOT NULL,
PRIMARY KEY (townId),
CONSTRAINT town_relates_to_city FOREIGN KEY (cityId) REFERENCES city (cityId) ON DELETE CASCADE ON UPDATE CASCADE
)
